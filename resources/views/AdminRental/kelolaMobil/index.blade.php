            ...
            <div class="card-body">
                ...
                <div class="fab-button animate dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="{{ route('adminRental.kelolaMobil.edit', $mobil->id) }}" class="dropdown-item bg-primary">
                            <ion-icon name="pencil-outline" role="img" class="md hydrated"
                                aria-label="cube outline"></ion-icon>
                            <p>Edit</p>
                        </a>
                        <form action="{{ route('adminRental.kelolaMobil.aktif', $mobil->id) }}" method="post" id="formAktif">
                            @method('patch')
                            @csrf
                        ...
                        <form action="{{ route('adminRental.kelolaMobil.destroy', $mobil->id) }}" method="post" id="formDeleteMobil">
                            @method('delete')
                            @csrf
                            <button type="button" onclick="formConfirmation2('Hapus mobil ?')" class="dropdown-item bg-danger"
