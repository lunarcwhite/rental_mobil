<div class="form-group basic">
    <div class="input-wrapper">
        ...
        <input type="text" name="namaMobil" value="{{ $mobil->namaMobil }}" class="form-control" id="namaMobil"
...
<div class="form-group basic">
    <div class="input-wrapper">
        ...
        <input type="text" name="platMobil" value="{{ $mobil->platMobil }}" class="form-control" id="platMobil"
...
<div class="form-group basic">
    <div class="input-wrapper">
        ...
        <input type="number" class="form-control" value="{{ $mobil->jumlahKursi }}" name="jumlahKursi" id="jumlahKursi"
...
<div class="wide-block p-0">
    ...
    <div class="input-list">
        @if ($mobil->bahanBakar != null && $mobil->bahanBakar == 'Bensin')
            <div class="custom-control custom-radio">
                <input type="radio" id="bensin" checked name="bahanBakar" value="Bensin"
        ...
        @else
            ...
            <div class="custom-control custom-radio">
                <input type="radio" id="solar" checked name="bahanBakar" value="Solar"
                    class="custom-control-input">
                <label class="custom-control-label" for="solar">Solar</label>
            </div>
        @endif
...
<div class="form-group basic">
    <div class="input-wrapper">
        ...
        <input type="number" value="{{ $mobil->harga }}" class="form-control" id="harga" name="harga"
            placeholder="Harga">
        <i class="clear-input">
            <ion-icon name="close-circle"></ion-icon>
        </i>
...
<div class="form-group basic">
    <div class="input-wrapper">
        ...
        <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" class="form-control">{{ $mobil->deskripsi }}</textarea>
        <i class="clear-input">
            <ion-icon name="close-circle"></ion-icon>
        </i>
    </div>
...
<div class="section full">
    ...
    <button type="button" class="btn btn-sm btn-info mb-1" data-toggle="modal" data-target="#lihatMobil">Lihat
        Foto</button>
    <div class="wide-block pb-2 pt-2" id="gambarMobil">
        <div class="custom-file-upload">
            <input type="file" id="fileuploadInput" class="form-control" name="gambar"
                accept=".png, .jpg, .jpeg">
            <label for="fileuploadInput">
                <span>
                    <strong id="klikDisini">
